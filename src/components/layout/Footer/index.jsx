          ...
          <div className="col-span-1 md:col-span-3 lg:col-span-2 flex flex-col gap-6">
            ...
            <div className="flex flex-col mt-4 mb-6">
              <div className="flex items-center gap-2">
                ...
                />
                <span className="text-black font-bold text-2xl tracking-tight leading-none" style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}>Meta</span>
              </div>
              <span className="text-gray-600 font-medium text-[16px] tracking-wide mt-1 ml-1">Business Partner</span>
            </div>
