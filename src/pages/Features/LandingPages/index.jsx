...
export default function LandingPagesFeature() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <p className="text-lg lg:text-xl text-[var(--text-secondary)] font-nunito leading-relaxed max-w-xl">
            High-converting, lightning-fast landing pages and full websites built with modern technologies to wow your visitors and capture leads.
          </p>

          <div className="pt-4">
            <h3 className="text-xl font-bold text-white mb-4">Key Benefits:</h3>
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <li className="flex items-center gap-2 text-[var(--text-secondary)]"><Zap size={16} className="text-[var(--accent-green)]" /><span>Responsive Design</span></li>
              <li className="flex items-center gap-2 text-[var(--text-secondary)]"><Zap size={16} className="text-[var(--accent-green)]" /><span>Ultra Fast Loading</span></li>
              <li className="flex items-center gap-2 text-[var(--text-secondary)]"><Zap size={16} className="text-[var(--accent-green)]" /><span>Conversion Optimized</span></li>
              <li className="flex items-center gap-2 text-[var(--text-secondary)]"><Zap size={16} className="text-[var(--accent-green)]" /><span>Modern UI/UX</span></li>
            </ul>
          </div>
        ...
        >
          ...
          <div className="relative z-10 text-center px-8">
            ...
            <p className="text-[var(--text-secondary)]">Experience the power of Landing Pages & Websites today.</p>
          </div>
        </motion.div>
      </div>
    </div>
