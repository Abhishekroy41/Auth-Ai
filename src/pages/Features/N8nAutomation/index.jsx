      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <p className="text-lg lg:text-xl text-[var(--text-secondary)] font-nunito leading-relaxed max-w-xl">
            Automate complex workflows and connect all your apps without writing a single line of code. Save hours of manual work every week.
          </p>

          <div className="pt-4">
            <h3 className="text-xl font-bold text-white mb-4">Key Benefits:</h3>
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <li className="flex items-center gap-2 text-[var(--text-secondary)]"><Zap size={16} className="text-[var(--accent-green)]" /><span>Visual Workflow Builder</span></li>
              <li className="flex items-center gap-2 text-[var(--text-secondary)]"><Zap size={16} className="text-[var(--accent-green)]" /><span>200+ Integrations</span></li>
              <li className="flex items-center gap-2 text-[var(--text-secondary)]"><Zap size={16} className="text-[var(--accent-green)]" /><span>Custom Webhooks</span></li>
              <li className="flex items-center gap-2 text-[var(--text-secondary)]"><Zap size={16} className="text-[var(--accent-green)]" /><span>Error Handling</span></li>
            </ul>
          </div>
        ...
        >
          ...
          <div className="relative z-10 text-center px-8">
            ...
            <p className="text-[var(--text-secondary)]">Experience the power of n8n Automation today.</p>
          </div>
        </motion.div>
      </div>
    </div>
